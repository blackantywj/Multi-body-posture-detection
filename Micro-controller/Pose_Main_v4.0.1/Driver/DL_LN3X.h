...
#define MCU_PORT3	 (0x83)	   /* User */
/*-------------------本模块配置-------------------*/
#define DL_ADDRESS             (0x0001)					 /*主机模块*/
#define DL_ADDRESS_H		   (0x00)
#define DL_ADDRESS_L		   (0x01)
#define DL_Main_ADDRESS_H	   (0x00)
#define DL_Main_ADDRESS_L	   (0x01)
#define DL2_ADDRESS_H		   (0x00)					 /*姿态模块1*/
#define DL2_ADDRESS_L		   (0x02)
#define DL3_ADDRESS_H		   (0x00)					 /*高度模块*/
#define DL3_ADDRESS_L		   (0x03)
#define DL4_ADDRESS_H		   (0x00)					 /*姿态模块2*/
#define DL4_ADDRESS_L		   (0x04)
...
extern float Roll_2, Pitch_2, Yaw_2;    				//姿态角
