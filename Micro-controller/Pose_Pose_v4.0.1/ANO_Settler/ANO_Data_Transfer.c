...
void ANO_DT_Data_Exchange(void) //2ms一次
{
	...
	if (f.send_senser)
	{
		...
		/*ANO_DT_Send_Senser(mpu9250.Acc_I16.x, mpu9250.Acc_I16.y, mpu9250.Acc_I16.z,
						   mpu9250.Gyro_I16.x, mpu9250.Gyro_I16.y, mpu9250.Gyro_I16.z,
						   mpu9250.Mag_Val.x, mpu9250.Mag_Val.y, mpu9250.Mag_Val.z);*/
#endif //MPU9250
	}
	/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_senser2 = 0;
//		ANO_DT_Send_Senser2(baro.height, baro.relative_height);
	}
}
...
//	data_to_send[_cnt++] = BYTE0(_temp);
	...
	_temp = (s16)mpu9250.Acc_I16.x;           //3
	data_to_send[_cnt++] = BYTE1(_temp);
	data_to_send[_cnt++] = BYTE0(_temp);

	_temp = (s16)mpu9250.Acc_I16.y;           //4
	data_to_send[_cnt++] = BYTE1(_temp);
	data_to_send[_cnt++] = BYTE0(_temp);

	_temp = (s16)mpu9250.Acc_I16.z;           //5
	data_to_send[_cnt++] = BYTE1(_temp);
	data_to_send[_cnt++] = BYTE0(_temp);

	_temp = (s16)mpu9250.Gyro_I16.x;           //6
	data_to_send[_cnt++] = BYTE1(_temp);
	data_to_send[_cnt++] = BYTE0(_temp);

	_temp = (s16)mpu9250.Gyro_I16.y;           //7
	data_to_send[_cnt++] = BYTE1(_temp);
	data_to_send[_cnt++] = BYTE0(_temp);

	_temp = (s16)mpu9250.Gyro_I16.z;           //8
	data_to_send[_cnt++] = BYTE1(_temp);
	data_to_send[_cnt++] = BYTE0(_temp);

	_temp = (s16)mpu9250.Mag_Adc.x/*T_X*/;           //9
	data_to_send[_cnt++] = BYTE1(_temp);
	data_to_send[_cnt++] = BYTE0(_temp);

	_temp = (s16)mpu9250.Mag_Adc.y/*T_Y*/;           //10
	data_to_send[_cnt++] = BYTE1(_temp);
	data_to_send[_cnt++] = BYTE0(_temp);

	_temp = (s16)mpu9250.Mag_Adc.z/*T_Z*/;           //11
	data_to_send[_cnt++] = BYTE1(_temp);
	data_to_send[_cnt++] = BYTE0(_temp);

//	_temp = (s16)(mpu9250.Ftempreature) * 10;        //12
//	data_to_send[_cnt++] = BYTE1(_temp);
//	data_to_send[_cnt++] = BYTE0(_temp);

#endif //MPU9250

	//_temp = (s16)(Roll_ANO*100);          //13
	//data_to_send[_cnt++] = BYTE1(_temp);
	//data_to_send[_cnt++] = BYTE0(_temp);
	//_temp = (s16)(Pitch_ANO * 100);          //13
	//data_to_send[_cnt++] = BYTE1(_temp);
	//data_to_send[_cnt++] = BYTE0(_temp);
	//_temp = (s16)(Yaw_ANO * 100);          //13
	//data_to_send[_cnt++] = BYTE1(_temp);
	//data_to_send[_cnt++] = BYTE0(_temp);

	//_temp = (s16)(Roll_NEW_XILUNA * 100);          //13
	//data_to_send[_cnt++] = BYTE1(_temp);
	//data_to_send[_cnt++] = BYTE0(_temp);
	//_temp = (s16)(Pitch_NEW_XILUNA * 100);          //14
	//data_to_send[_cnt++] = BYTE1(_temp);
	//data_to_send[_cnt++] = BYTE0(_temp);
	//_temp = (s16)(Yaw_NEW_XILUNA * 100);          //15
	//data_to_send[_cnt++] = BYTE1(_temp);
	//data_to_send[_cnt++] = BYTE0(_temp);

//	_temp = (s16)(ewx * 10000);          //13
//	data_to_send[_cnt++] = BYTE1(_temp);
//	data_to_send[_cnt++] = BYTE0(_temp);
//	_temp = (s16)(ewy * 10000);          //14
//	data_to_send[_cnt++] = BYTE1(_temp);
//	data_to_send[_cnt++] = BYTE0(_temp);
//	_temp = (s16)(ewz * 10000);          //15
//	data_to_send[_cnt++] = BYTE1(_temp);
//	data_to_send[_cnt++] = BYTE0(_temp);
//	
